...
ckpt_dir = '/home/yzb/model/models--robovlms--RoboFlamingo/snapshots/b08c0a2ac4d2a92927ddc066e3eb077319bc5a94'
# ckpt_names = ['checkpoint_gripper_post_hist_1_aug_10_4_traj_cons_ws_12_mpt_9b_2.pth']
# ckpt_names = ['cofinetune_checkpoint_gripper_post_hist_1_aug_10_4_traj_cons_ws_12_mpt_dolly_3b_3.pth']
...
for ckpt_name in ckpt_names:
    ...
    log_file = 'logs_new/e_test_{}.log'.format(ckpt_name.split('.')[0])
